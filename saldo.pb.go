...
const file_saldo_proto_rawDesc = "" +
	...
	"\x04data\x18\x03 \x01(\v2\x11.pb.SaldoResponseR\x04data\"l\n" +
	...
	"\vUpdateSaldo\x12\x16.pb.UpdateSaldoRequest\x1a\x14.pb.ApiResponseSaldo\"\x00\x12@\n" +
	"\fTrashedSaldo\x12\x18.pb.FindByIdSaldoRequest\x1a\x14.pb.ApiResponseSaldo\"\x00\x12@\n" +
	"\fRestoreSaldo\x12\x18.pb.FindByIdSaldoRequest\x1a\x14.pb.ApiResponseSaldo\"\x00\x12N\n" +
...
var file_saldo_proto_goTypes = []any{
	...
	(*PaginationMeta)(nil),                     // 23: pb.PaginationMeta
	(*FindByCardNumberRequest)(nil),            // 24: pb.FindByCardNumberRequest
	(*emptypb.Empty)(nil),                      // 25: google.protobuf.Empty
}
var file_saldo_proto_depIdxs = []int32{
	22, // 0: pb.SaldoResponseDeleteAt.deleted_at:type_name -> google.protobuf.StringValue
	6,  // 1: pb.ApiResponseSaldo.data:type_name -> pb.SaldoResponse
	6,  // 2: pb.ApiResponsesSaldo.data:type_name -> pb.SaldoResponse
	8,  // 3: pb.ApiResponseMonthTotalSaldo.data:type_name -> pb.SaldoMonthTotalBalanceResponse
	9,  // 4: pb.ApiResponseYearTotalSaldo.data:type_name -> pb.SaldoYearTotalBalanceResponse
	10, // 5: pb.ApiResponseMonthSaldoBalances.data:type_name -> pb.SaldoMonthBalanceResponse
	11, // 6: pb.ApiResponseYearSaldoBalances.data:type_name -> pb.SaldoYearBalanceResponse
	6,  // 7: pb.ApiResponsePaginationSaldo.data:type_name -> pb.SaldoResponse
	23, // 8: pb.ApiResponsePaginationSaldo.pagination:type_name -> pb.PaginationMeta
	7,  // 9: pb.ApiResponsePaginationSaldoDeleteAt.data:type_name -> pb.SaldoResponseDeleteAt
	23, // 10: pb.ApiResponsePaginationSaldoDeleteAt.pagination:type_name -> pb.PaginationMeta
	0,  // 11: pb.SaldoService.FindAllSaldo:input_type -> pb.FindAllSaldoRequest
	3,  // 12: pb.SaldoService.FindByIdSaldo:input_type -> pb.FindByIdSaldoRequest
	1,  // 13: pb.SaldoService.FindMonthlyTotalSaldoBalance:input_type -> pb.FindMonthlySaldoTotalBalance
	2,  // 14: pb.SaldoService.FindYearTotalSaldoBalance:input_type -> pb.FindYearlySaldo
	2,  // 15: pb.SaldoService.FindMonthlySaldoBalances:input_type -> pb.FindYearlySaldo
	2,  // 16: pb.SaldoService.FindYearlySaldoBalances:input_type -> pb.FindYearlySaldo
	24, // 17: pb.SaldoService.FindByCardNumber:input_type -> pb.FindByCardNumberRequest
	0,  // 18: pb.SaldoService.FindByActive:input_type -> pb.FindAllSaldoRequest
	0,  // 19: pb.SaldoService.FindByTrashed:input_type -> pb.FindAllSaldoRequest
	4,  // 20: pb.SaldoService.CreateSaldo:input_type -> pb.CreateSaldoRequest
	5,  // 21: pb.SaldoService.UpdateSaldo:input_type -> pb.UpdateSaldoRequest
	3,  // 22: pb.SaldoService.TrashedSaldo:input_type -> pb.FindByIdSaldoRequest
	3,  // 23: pb.SaldoService.RestoreSaldo:input_type -> pb.FindByIdSaldoRequest
	3,  // 24: pb.SaldoService.DeleteSaldoPermanent:input_type -> pb.FindByIdSaldoRequest
	25, // 25: pb.SaldoService.RestoreAllSaldo:input_type -> google.protobuf.Empty
	25, // 26: pb.SaldoService.DeleteAllSaldoPermanent:input_type -> google.protobuf.Empty
	20, // 27: pb.SaldoService.FindAllSaldo:output_type -> pb.ApiResponsePaginationSaldo
	12, // 28: pb.SaldoService.FindByIdSaldo:output_type -> pb.ApiResponseSaldo
	16, // 29: pb.SaldoService.FindMonthlyTotalSaldoBalance:output_type -> pb.ApiResponseMonthTotalSaldo
	17, // 30: pb.SaldoService.FindYearTotalSaldoBalance:output_type -> pb.ApiResponseYearTotalSaldo
	18, // 31: pb.SaldoService.FindMonthlySaldoBalances:output_type -> pb.ApiResponseMonthSaldoBalances
	19, // 32: pb.SaldoService.FindYearlySaldoBalances:output_type -> pb.ApiResponseYearSaldoBalances
	12, // 33: pb.SaldoService.FindByCardNumber:output_type -> pb.ApiResponseSaldo
	21, // 34: pb.SaldoService.FindByActive:output_type -> pb.ApiResponsePaginationSaldoDeleteAt
	21, // 35: pb.SaldoService.FindByTrashed:output_type -> pb.ApiResponsePaginationSaldoDeleteAt
	12, // 36: pb.SaldoService.CreateSaldo:output_type -> pb.ApiResponseSaldo
	12, // 37: pb.SaldoService.UpdateSaldo:output_type -> pb.ApiResponseSaldo
	12, // 38: pb.SaldoService.TrashedSaldo:output_type -> pb.ApiResponseSaldo
	12, // 39: pb.SaldoService.RestoreSaldo:output_type -> pb.ApiResponseSaldo
	14, // 40: pb.SaldoService.DeleteSaldoPermanent:output_type -> pb.ApiResponseSaldoDelete
	15, // 41: pb.SaldoService.RestoreAllSaldo:output_type -> pb.ApiResponseSaldoAll
	15, // 42: pb.SaldoService.DeleteAllSaldoPermanent:output_type -> pb.ApiResponseSaldoAll
