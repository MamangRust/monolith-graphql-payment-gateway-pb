...
func (x *ApiResponsePaginationSaldoDeleteAt) Reset() {
	*x = ApiResponsePaginationSaldoDeleteAt{}
	mi := &file_saldo_proto_msgTypes[22]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ApiResponsePaginationSaldoDeleteAt) Descriptor() ([]byte, []int) {
	return file_saldo_proto_rawDescGZIP(), []int{22}
}
...
const file_saldo_proto_rawDesc = "" +
	"\n" +
	"\vsaldo.proto\x12\x02pb\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\tapi.proto\x1a\n" +
	"card.proto\"^\n" +
	...
	"\bsaldo_id\x18\x01 \x01(\x05R\asaldoId\"Z\n" +
	...
	"cardNumber\x12#\n" +
	"\rtotal_balance\x18\x03 \x01(\x05R\ftotalBalance\"\xfc\x01\n" +
	...
	"\n" +
	"deleted_at\x18\b \x01(\v2\x1c.google.protobuf.StringValueR\tdeletedAt\"o\n" +
	...
	"\rtotal_balance\x18\x02 \x01(\x05R\ftotalBalance\"V\n" +
	...
	"\x04year\x18\x01 \x01(\tR\x04year\x12#\n" +
	"\rtotal_balance\x18\x02 \x01(\x05R\ftotalBalance\"k\n" +
	"\x10ApiResponseSaldo\x12\x16\n" +
	"\x06status\x18\x01 \x01(\tR\x06status\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12%\n" +
	"\x04data\x18\x03 \x01(\v2\x11.pb.SaldoResponseR\x04data\"{\n" +
	"\x18ApiResponseSaldoDeleteAt\x12\x16\n" +
	"\x06status\x18\x01 \x01(\tR\x06status\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12-\n" +
	"\x04data\x18\x03 \x01(\v2\x19.pb.SaldoResponseDeleteAtR\x04data\"l\n" +
	"\x11ApiResponsesSaldo\x12\x16\n" +
	"\x06status\x18\x01 \x01(\tR\x06status\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12%\n" +
	"\x04data\x18\x03 \x03(\v2\x11.pb.SaldoResponseR\x04data\"J\n" +
	...
	"\x04data\x18\x03 \x03(\v2\".pb.SaldoMonthTotalBalanceResponseR\x04data\"\x84\x01\n" +
	"\x19ApiResponseYearTotalSaldo\x12\x16\n" +
	"\x06status\x18\x01 \x01(\tR\x06status\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x125\n" +
	"\x04data\x18\x03 \x03(\v2!.pb.SaldoYearTotalBalanceResponseR\x04data\"\x84\x01\n" +
	"\x1dApiResponseMonthSaldoBalances\x12\x16\n" +
	"\x06status\x18\x01 \x01(\tR\x06status\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x121\n" +
	"\x04data\x18\x03 \x03(\v2\x1d.pb.SaldoMonthBalanceResponseR\x04data\"\x82\x01\n" +
	"\x1cApiResponseYearSaldoBalances\x12\x16\n" +
	"\x06status\x18\x01 \x01(\tR\x06status\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x120\n" +
	"\x04data\x18\x03 \x03(\v2\x1c.pb.SaldoYearBalanceResponseR\x04data\"\xa9\x01\n" +
	"\x1aApiResponsePaginationSaldo\x12\x16\n" +
	"\x06status\x18\x01 \x01(\tR\x06status\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12%\n" +
	"\x04data\x18\x03 \x03(\v2\x11.pb.SaldoResponseR\x04data\x122\n" +
	"\n" +
	...
	"\x06status\x18\x01 \x01(\tR\x06status\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12-\n" +
	"\x04data\x18\x03 \x03(\v2\x19.pb.SaldoResponseDeleteAtR\x04data\x122\n" +
	"\n" +
	"pagination\x18\x04 \x01(\v2\x12.pb.PaginationMetaR\n" +
	"pagination2\xe3\t\n" +
	"\fSaldoService\x12I\n" +
	"\fFindAllSaldo\x12\x17.pb.FindAllSaldoRequest\x1a\x1e.pb.ApiResponsePaginationSaldo\"\x00\x12A\n" +
	"\rFindByIdSaldo\x12\x18.pb.FindByIdSaldoRequest\x1a\x14.pb.ApiResponseSaldo\"\x00\x12b\n" +
	"\x1cFindMonthlyTotalSaldoBalance\x12 .pb.FindMonthlySaldoTotalBalance\x1a\x1e.pb.ApiResponseMonthTotalSaldo\"\x00\x12Q\n" +
	"\x19FindYearTotalSaldoBalance\x12\x13.pb.FindYearlySaldo\x1a\x1d.pb.ApiResponseYearTotalSaldo\"\x00\x12T\n" +
	"\x18FindMonthlySaldoBalances\x12\x13.pb.FindYearlySaldo\x1a!.pb.ApiResponseMonthSaldoBalances\"\x00\x12R\n" +
	"\x17FindYearlySaldoBalances\x12\x13.pb.FindYearlySaldo\x1a .pb.ApiResponseYearSaldoBalances\"\x00\x12G\n" +
	"\x10FindByCardNumber\x12\x1b.pb.FindByCardNumberRequest\x1a\x14.pb.ApiResponseSaldo\"\x00\x12Q\n" +
	"\fFindByActive\x12\x17.pb.FindAllSaldoRequest\x1a&.pb.ApiResponsePaginationSaldoDeleteAt\"\x00\x12R\n" +
	"\rFindByTrashed\x12\x17.pb.FindAllSaldoRequest\x1a&.pb.ApiResponsePaginationSaldoDeleteAt\"\x00\x12=\n" +
	"\vCreateSaldo\x12\x16.pb.CreateSaldoRequest\x1a\x14.pb.ApiResponseSaldo\"\x00\x12=\n" +
	"\vUpdateSaldo\x12\x16.pb.UpdateSaldoRequest\x1a\x14.pb.ApiResponseSaldo\"\x00\x12H\n" +
	"\fTrashedSaldo\x12\x18.pb.FindByIdSaldoRequest\x1a\x1c.pb.ApiResponseSaldoDeleteAt\"\x00\x12H\n" +
	"\fRestoreSaldo\x12\x18.pb.FindByIdSaldoRequest\x1a\x1c.pb.ApiResponseSaldoDeleteAt\"\x00\x12N\n" +
	"\x14DeleteSaldoPermanent\x12\x18.pb.FindByIdSaldoRequest\x1a\x1a.pb.ApiResponseSaldoDelete\"\x00\x12D\n" +
	"\x0fRestoreAllSaldo\x12\x16.google.protobuf.Empty\x1a\x17.pb.ApiResponseSaldoAll\"\x00\x12L\n" +
	"\x17DeleteAllSaldoPermanent\x12\x16.google.protobuf.Empty\x1a\x17.pb.ApiResponseSaldoAll\"\x00B;Z9github.com/MamangRust/monolith-graphql-payment-gateway-pbb\x06proto3"

var (
	file_saldo_proto_rawDescOnce sync.Once
	file_saldo_proto_rawDescData []byte
)

func file_saldo_proto_rawDescGZIP() []byte {
	file_saldo_proto_rawDescOnce.Do(func() {
		file_saldo_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_saldo_proto_rawDesc), len(file_saldo_proto_rawDesc)))
	})
	return file_saldo_proto_rawDescData
}

var file_saldo_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
var file_saldo_proto_goTypes = []any{
	...
	(*ApiResponseSaldoDeleteAt)(nil),           // 13: pb.ApiResponseSaldoDeleteAt
	(*ApiResponsesSaldo)(nil),                  // 14: pb.ApiResponsesSaldo
	(*ApiResponseSaldoDelete)(nil),             // 15: pb.ApiResponseSaldoDelete
	(*ApiResponseSaldoAll)(nil),                // 16: pb.ApiResponseSaldoAll
	(*ApiResponseMonthTotalSaldo)(nil),         // 17: pb.ApiResponseMonthTotalSaldo
	(*ApiResponseYearTotalSaldo)(nil),          // 18: pb.ApiResponseYearTotalSaldo
	(*ApiResponseMonthSaldoBalances)(nil),      // 19: pb.ApiResponseMonthSaldoBalances
	(*ApiResponseYearSaldoBalances)(nil),       // 20: pb.ApiResponseYearSaldoBalances
	(*ApiResponsePaginationSaldo)(nil),         // 21: pb.ApiResponsePaginationSaldo
	(*ApiResponsePaginationSaldoDeleteAt)(nil), // 22: pb.ApiResponsePaginationSaldoDeleteAt
	(*wrapperspb.StringValue)(nil),             // 23: google.protobuf.StringValue
	(*PaginationMeta)(nil),                     // 24: pb.PaginationMeta
	(*FindByCardNumberRequest)(nil),            // 25: pb.FindByCardNumberRequest
	(*emptypb.Empty)(nil),                      // 26: google.protobuf.Empty
}
var file_saldo_proto_depIdxs = []int32{
	23, // 0: pb.SaldoResponseDeleteAt.deleted_at:type_name -> google.protobuf.StringValue
	6,  // 1: pb.ApiResponseSaldo.data:type_name -> pb.SaldoResponse
	7,  // 2: pb.ApiResponseSaldoDeleteAt.data:type_name -> pb.SaldoResponseDeleteAt
	6,  // 3: pb.ApiResponsesSaldo.data:type_name -> pb.SaldoResponse
	8,  // 4: pb.ApiResponseMonthTotalSaldo.data:type_name -> pb.SaldoMonthTotalBalanceResponse
	9,  // 5: pb.ApiResponseYearTotalSaldo.data:type_name -> pb.SaldoYearTotalBalanceResponse
	10, // 6: pb.ApiResponseMonthSaldoBalances.data:type_name -> pb.SaldoMonthBalanceResponse
	11, // 7: pb.ApiResponseYearSaldoBalances.data:type_name -> pb.SaldoYearBalanceResponse
	6,  // 8: pb.ApiResponsePaginationSaldo.data:type_name -> pb.SaldoResponse
	24, // 9: pb.ApiResponsePaginationSaldo.pagination:type_name -> pb.PaginationMeta
	7,  // 10: pb.ApiResponsePaginationSaldoDeleteAt.data:type_name -> pb.SaldoResponseDeleteAt
	24, // 11: pb.ApiResponsePaginationSaldoDeleteAt.pagination:type_name -> pb.PaginationMeta
	0,  // 12: pb.SaldoService.FindAllSaldo:input_type -> pb.FindAllSaldoRequest
	3,  // 13: pb.SaldoService.FindByIdSaldo:input_type -> pb.FindByIdSaldoRequest
	1,  // 14: pb.SaldoService.FindMonthlyTotalSaldoBalance:input_type -> pb.FindMonthlySaldoTotalBalance
	2,  // 15: pb.SaldoService.FindYearTotalSaldoBalance:input_type -> pb.FindYearlySaldo
	2,  // 16: pb.SaldoService.FindMonthlySaldoBalances:input_type -> pb.FindYearlySaldo
	2,  // 17: pb.SaldoService.FindYearlySaldoBalances:input_type -> pb.FindYearlySaldo
	25, // 18: pb.SaldoService.FindByCardNumber:input_type -> pb.FindByCardNumberRequest
	0,  // 19: pb.SaldoService.FindByActive:input_type -> pb.FindAllSaldoRequest
	0,  // 20: pb.SaldoService.FindByTrashed:input_type -> pb.FindAllSaldoRequest
	4,  // 21: pb.SaldoService.CreateSaldo:input_type -> pb.CreateSaldoRequest
	5,  // 22: pb.SaldoService.UpdateSaldo:input_type -> pb.UpdateSaldoRequest
	3,  // 23: pb.SaldoService.TrashedSaldo:input_type -> pb.FindByIdSaldoRequest
	3,  // 24: pb.SaldoService.RestoreSaldo:input_type -> pb.FindByIdSaldoRequest
	3,  // 25: pb.SaldoService.DeleteSaldoPermanent:input_type -> pb.FindByIdSaldoRequest
	26, // 26: pb.SaldoService.RestoreAllSaldo:input_type -> google.protobuf.Empty
	26, // 27: pb.SaldoService.DeleteAllSaldoPermanent:input_type -> google.protobuf.Empty
	21, // 28: pb.SaldoService.FindAllSaldo:output_type -> pb.ApiResponsePaginationSaldo
	12, // 29: pb.SaldoService.FindByIdSaldo:output_type -> pb.ApiResponseSaldo
	17, // 30: pb.SaldoService.FindMonthlyTotalSaldoBalance:output_type -> pb.ApiResponseMonthTotalSaldo
	18, // 31: pb.SaldoService.FindYearTotalSaldoBalance:output_type -> pb.ApiResponseYearTotalSaldo
	19, // 32: pb.SaldoService.FindMonthlySaldoBalances:output_type -> pb.ApiResponseMonthSaldoBalances
	20, // 33: pb.SaldoService.FindYearlySaldoBalances:output_type -> pb.ApiResponseYearSaldoBalances
	12, // 34: pb.SaldoService.FindByCardNumber:output_type -> pb.ApiResponseSaldo
	22, // 35: pb.SaldoService.FindByActive:output_type -> pb.ApiResponsePaginationSaldoDeleteAt
	22, // 36: pb.SaldoService.FindByTrashed:output_type -> pb.ApiResponsePaginationSaldoDeleteAt
	12, // 37: pb.SaldoService.CreateSaldo:output_type -> pb.ApiResponseSaldo
	12, // 38: pb.SaldoService.UpdateSaldo:output_type -> pb.ApiResponseSaldo
	13, // 39: pb.SaldoService.TrashedSaldo:output_type -> pb.ApiResponseSaldoDeleteAt
	13, // 40: pb.SaldoService.RestoreSaldo:output_type -> pb.ApiResponseSaldoDeleteAt
	15, // 41: pb.SaldoService.DeleteSaldoPermanent:output_type -> pb.ApiResponseSaldoDelete
	16, // 42: pb.SaldoService.RestoreAllSaldo:output_type -> pb.ApiResponseSaldoAll
	16, // 43: pb.SaldoService.DeleteAllSaldoPermanent:output_type -> pb.ApiResponseSaldoAll
...
func file_saldo_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_saldo_proto_rawDesc), len(file_saldo_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   23,
			NumExtensions: 0,
			NumServices:   1,
