...
func (x *ApiResponseRoleAll) Reset() {
	*x = ApiResponseRoleAll{}
	mi := &file_role_role_command_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ApiResponseRoleAll) Descriptor() ([]byte, []int) {
	return file_role_role_command_proto_rawDescGZIP(), []int{2}
}
...
func (x *ApiResponseRoleDelete) Reset() {
	*x = ApiResponseRoleDelete{}
	mi := &file_role_role_command_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ApiResponseRoleDelete) Descriptor() ([]byte, []int) {
	return file_role_role_command_proto_rawDescGZIP(), []int{3}
}
...
const file_role_role_command_proto_rawDesc = "" +
	"\n" +
	"\x17role/role_command.proto\x12\apb.role\x1a\x1bgoogle/protobuf/empty.proto\x1a\x0frole/role.proto\"'\n" +
	...
	"\x16DeleteAllRolePermanent\x12\x16.google.protobuf.Empty\x1a\x1b.pb.role.ApiResponseRoleAll\"\x00B@Z>github.com/MamangRust/monolith-graphql-payment-gateway-pb/roleb\x06proto3"
