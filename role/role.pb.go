...
const file_role_role_proto_rawDesc = "" +
	"\n" +
	"\x0frole/role.proto\x12\apb.role\x1a\x1egoogle/protobuf/wrappers.proto\"]\n" +
	...
	"\x06status\x18\x01 \x01(\tR\x06status\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12)\n" +
	"\x04data\x18\x03 \x03(\v2\x15.pb.role.RoleResponseR\x04dataB@Z>github.com/MamangRust/monolith-graphql-payment-gateway-pb/roleb\x06proto3"
