...
const file_card_proto_rawDesc = "" +
	...
	"\x04data\x18\x03 \x01(\v2\x10.pb.CardResponseR\x04data\"y\n" +
	"\x17ApiResponseCardDeleteAt\x12\x16\n" +
	"\x06status\x18\x01 \x01(\tR\x06status\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12,\n" +
	"\x04data\x18\x03 \x01(\v2\x18.pb.CardResponseDeleteAtR\x04data\"I\n" +
	...
	"\n" +
	"UpdateCard\x12\x15.pb.UpdateCardRequest\x1a\x13.pb.ApiResponseCard\"\x00\x12E\n" +
	"\vTrashedCard\x12\x17.pb.FindByIdCardRequest\x1a\x1b.pb.ApiResponseCardDeleteAt\"\x00\x12E\n" +
	"\vRestoreCard\x12\x17.pb.FindByIdCardRequest\x1a\x1b.pb.ApiResponseCardDeleteAt\"\x00\x12K\n" +
	...
	"\x16DeleteAllCardPermanent\x12\x16.google.protobuf.Empty\x1a\x16.pb.ApiResponseCardAll\"\x00B;Z9github.com/MamangRust/monolith-graphql-payment-gateway-pbb\x06proto3"
...
var file_card_proto_msgTypes = make([]protoimpl.MessageInfo, 33)
var file_card_proto_goTypes = []any{
	...
	(*ApiResponseCardDeleteAt)(nil),           // 13: pb.ApiResponseCardDeleteAt
	(*ApiResponseCardDelete)(nil),             // 14: pb.ApiResponseCardDelete
	(*ApiResponseCardAll)(nil),                // 15: pb.ApiResponseCardAll
	(*ApiResponsePaginationCard)(nil),         // 16: pb.ApiResponsePaginationCard
	(*ApiResponsePaginationCardDeleteAt)(nil), // 17: pb.ApiResponsePaginationCardDeleteAt
	(*ApiResponseMonthlyBalance)(nil),         // 18: pb.ApiResponseMonthlyBalance
	(*ApiResponseYearlyBalance)(nil),          // 19: pb.ApiResponseYearlyBalance
	(*ApiResponseMonthlyAmount)(nil),          // 20: pb.ApiResponseMonthlyAmount
	(*ApiResponseYearlyAmount)(nil),           // 21: pb.ApiResponseYearlyAmount
	(*ApiResponseDashboardCard)(nil),          // 22: pb.ApiResponseDashboardCard
	(*ApiResponseDashboardCardNumber)(nil),    // 23: pb.ApiResponseDashboardCardNumber
	(*FindByUserIdCardRequest)(nil),           // 24: pb.FindByUserIdCardRequest
	(*ApiResponseCards)(nil),                  // 25: pb.ApiResponseCards
	(*FindYearBalance)(nil),                   // 26: pb.FindYearBalance
	(*FindYearBalanceCardNumber)(nil),         // 27: pb.FindYearBalanceCardNumber
	(*FindYearAmount)(nil),                    // 28: pb.FindYearAmount
	(*FindYearAmountCardNumber)(nil),          // 29: pb.FindYearAmountCardNumber
	(*FindByActiveCardRequest)(nil),           // 30: pb.FindByActiveCardRequest
	(*FindByTrashedCardRequest)(nil),          // 31: pb.FindByTrashedCardRequest
	(*FindByCardNumberRequest)(nil),           // 32: pb.FindByCardNumberRequest
...
var file_card_proto_depIdxs = []int32{
	33, // 0: pb.CreateCardRequest.expire_date:type_name -> google.protobuf.Timestamp
	33, // 1: pb.UpdateCardRequest.expire_date:type_name -> google.protobuf.Timestamp
	34, // 2: pb.CardResponseDeleteAt.deleted_at:type_name -> google.protobuf.StringValue
	4,  // 3: pb.ApiResponseCard.data:type_name -> pb.CardResponse
	5,  // 4: pb.ApiResponseCardDeleteAt.data:type_name -> pb.CardResponseDeleteAt
	4,  // 5: pb.ApiResponsePaginationCard.data:type_name -> pb.CardResponse
	35, // 6: pb.ApiResponsePaginationCard.pagination:type_name -> pb.PaginationMeta
	5,  // 7: pb.ApiResponsePaginationCardDeleteAt.data:type_name -> pb.CardResponseDeleteAt
	35, // 8: pb.ApiResponsePaginationCardDeleteAt.pagination:type_name -> pb.PaginationMeta
	6,  // 9: pb.ApiResponseMonthlyBalance.data:type_name -> pb.CardResponseMonthlyBalance
	7,  // 10: pb.ApiResponseYearlyBalance.data:type_name -> pb.CardResponseYearlyBalance
	8,  // 11: pb.ApiResponseMonthlyAmount.data:type_name -> pb.CardResponseMonthlyAmount
	9,  // 12: pb.ApiResponseYearlyAmount.data:type_name -> pb.CardResponseYearlyAmount
	10, // 13: pb.ApiResponseDashboardCard.data:type_name -> pb.CardResponseDashboard
	11, // 14: pb.ApiResponseDashboardCardNumber.data:type_name -> pb.CardResponseDashboardCardNumber
	4,  // 15: pb.ApiResponseCards.data:type_name -> pb.CardResponse
	0,  // 16: pb.CardService.FindAllCard:input_type -> pb.FindAllCardRequest
	1,  // 17: pb.CardService.FindByIdCard:input_type -> pb.FindByIdCardRequest
	24, // 18: pb.CardService.FindByUserIdCard:input_type -> pb.FindByUserIdCardRequest
	0,  // 19: pb.CardService.FindByActiveCard:input_type -> pb.FindAllCardRequest
	0,  // 20: pb.CardService.FindByTrashedCard:input_type -> pb.FindAllCardRequest
	32, // 21: pb.CardService.FindByCardNumber:input_type -> pb.FindByCardNumberRequest
	36, // 22: pb.CardService.DashboardCard:input_type -> google.protobuf.Empty
	32, // 23: pb.CardService.DashboardCardNumber:input_type -> pb.FindByCardNumberRequest
	26, // 24: pb.CardService.FindMonthlyBalance:input_type -> pb.FindYearBalance
	26, // 25: pb.CardService.FindYearlyBalance:input_type -> pb.FindYearBalance
	28, // 26: pb.CardService.FindMonthlyTopupAmount:input_type -> pb.FindYearAmount
	28, // 27: pb.CardService.FindYearlyTopupAmount:input_type -> pb.FindYearAmount
	28, // 28: pb.CardService.FindMonthlyWithdrawAmount:input_type -> pb.FindYearAmount
	28, // 29: pb.CardService.FindYearlyWithdrawAmount:input_type -> pb.FindYearAmount
	28, // 30: pb.CardService.FindMonthlyTransactionAmount:input_type -> pb.FindYearAmount
	28, // 31: pb.CardService.FindYearlyTransactionAmount:input_type -> pb.FindYearAmount
	28, // 32: pb.CardService.FindMonthlyTransferSenderAmount:input_type -> pb.FindYearAmount
	28, // 33: pb.CardService.FindYearlyTransferSenderAmount:input_type -> pb.FindYearAmount
	28, // 34: pb.CardService.FindMonthlyTransferReceiverAmount:input_type -> pb.FindYearAmount
	28, // 35: pb.CardService.FindYearlyTransferReceiverAmount:input_type -> pb.FindYearAmount
	27, // 36: pb.CardService.FindMonthlyBalanceByCardNumber:input_type -> pb.FindYearBalanceCardNumber
	27, // 37: pb.CardService.FindYearlyBalanceByCardNumber:input_type -> pb.FindYearBalanceCardNumber
	29, // 38: pb.CardService.FindMonthlyTopupAmountByCardNumber:input_type -> pb.FindYearAmountCardNumber
	29, // 39: pb.CardService.FindYearlyTopupAmountByCardNumber:input_type -> pb.FindYearAmountCardNumber
	29, // 40: pb.CardService.FindMonthlyWithdrawAmountByCardNumber:input_type -> pb.FindYearAmountCardNumber
	29, // 41: pb.CardService.FindYearlyWithdrawAmountByCardNumber:input_type -> pb.FindYearAmountCardNumber
	29, // 42: pb.CardService.FindMonthlyTransactionAmountByCardNumber:input_type -> pb.FindYearAmountCardNumber
	29, // 43: pb.CardService.FindYearlyTransactionAmountByCardNumber:input_type -> pb.FindYearAmountCardNumber
	29, // 44: pb.CardService.FindMonthlyTransferSenderAmountByCardNumber:input_type -> pb.FindYearAmountCardNumber
	29, // 45: pb.CardService.FindYearlyTransferSenderAmountByCardNumber:input_type -> pb.FindYearAmountCardNumber
	29, // 46: pb.CardService.FindMonthlyTransferReceiverAmountByCardNumber:input_type -> pb.FindYearAmountCardNumber
	29, // 47: pb.CardService.FindYearlyTransferReceiverAmountByCardNumber:input_type -> pb.FindYearAmountCardNumber
	2,  // 48: pb.CardService.CreateCard:input_type -> pb.CreateCardRequest
	3,  // 49: pb.CardService.UpdateCard:input_type -> pb.UpdateCardRequest
	1,  // 50: pb.CardService.TrashedCard:input_type -> pb.FindByIdCardRequest
	1,  // 51: pb.CardService.RestoreCard:input_type -> pb.FindByIdCardRequest
	1,  // 52: pb.CardService.DeleteCardPermanent:input_type -> pb.FindByIdCardRequest
	36, // 53: pb.CardService.RestoreAllCard:input_type -> google.protobuf.Empty
	36, // 54: pb.CardService.DeleteAllCardPermanent:input_type -> google.protobuf.Empty
	16, // 55: pb.CardService.FindAllCard:output_type -> pb.ApiResponsePaginationCard
	12, // 56: pb.CardService.FindByIdCard:output_type -> pb.ApiResponseCard
	12, // 57: pb.CardService.FindByUserIdCard:output_type -> pb.ApiResponseCard
	17, // 58: pb.CardService.FindByActiveCard:output_type -> pb.ApiResponsePaginationCardDeleteAt
	17, // 59: pb.CardService.FindByTrashedCard:output_type -> pb.ApiResponsePaginationCardDeleteAt
	12, // 60: pb.CardService.FindByCardNumber:output_type -> pb.ApiResponseCard
	22, // 61: pb.CardService.DashboardCard:output_type -> pb.ApiResponseDashboardCard
	23, // 62: pb.CardService.DashboardCardNumber:output_type -> pb.ApiResponseDashboardCardNumber
	18, // 63: pb.CardService.FindMonthlyBalance:output_type -> pb.ApiResponseMonthlyBalance
	19, // 64: pb.CardService.FindYearlyBalance:output_type -> pb.ApiResponseYearlyBalance
	20, // 65: pb.CardService.FindMonthlyTopupAmount:output_type -> pb.ApiResponseMonthlyAmount
	21, // 66: pb.CardService.FindYearlyTopupAmount:output_type -> pb.ApiResponseYearlyAmount
	20, // 67: pb.CardService.FindMonthlyWithdrawAmount:output_type -> pb.ApiResponseMonthlyAmount
	21, // 68: pb.CardService.FindYearlyWithdrawAmount:output_type -> pb.ApiResponseYearlyAmount
	20, // 69: pb.CardService.FindMonthlyTransactionAmount:output_type -> pb.ApiResponseMonthlyAmount
	21, // 70: pb.CardService.FindYearlyTransactionAmount:output_type -> pb.ApiResponseYearlyAmount
	20, // 71: pb.CardService.FindMonthlyTransferSenderAmount:output_type -> pb.ApiResponseMonthlyAmount
	21, // 72: pb.CardService.FindYearlyTransferSenderAmount:output_type -> pb.ApiResponseYearlyAmount
	20, // 73: pb.CardService.FindMonthlyTransferReceiverAmount:output_type -> pb.ApiResponseMonthlyAmount
	21, // 74: pb.CardService.FindYearlyTransferReceiverAmount:output_type -> pb.ApiResponseYearlyAmount
	18, // 75: pb.CardService.FindMonthlyBalanceByCardNumber:output_type -> pb.ApiResponseMonthlyBalance
	19, // 76: pb.CardService.FindYearlyBalanceByCardNumber:output_type -> pb.ApiResponseYearlyBalance
	20, // 77: pb.CardService.FindMonthlyTopupAmountByCardNumber:output_type -> pb.ApiResponseMonthlyAmount
	21, // 78: pb.CardService.FindYearlyTopupAmountByCardNumber:output_type -> pb.ApiResponseYearlyAmount
	20, // 79: pb.CardService.FindMonthlyWithdrawAmountByCardNumber:output_type -> pb.ApiResponseMonthlyAmount
	21, // 80: pb.CardService.FindYearlyWithdrawAmountByCardNumber:output_type -> pb.ApiResponseYearlyAmount
	20, // 81: pb.CardService.FindMonthlyTransactionAmountByCardNumber:output_type -> pb.ApiResponseMonthlyAmount
	21, // 82: pb.CardService.FindYearlyTransactionAmountByCardNumber:output_type -> pb.ApiResponseYearlyAmount
	20, // 83: pb.CardService.FindMonthlyTransferSenderAmountByCardNumber:output_type -> pb.ApiResponseMonthlyAmount
	21, // 84: pb.CardService.FindYearlyTransferSenderAmountByCardNumber:output_type -> pb.ApiResponseYearlyAmount
	20, // 85: pb.CardService.FindMonthlyTransferReceiverAmountByCardNumber:output_type -> pb.ApiResponseMonthlyAmount
	21, // 86: pb.CardService.FindYearlyTransferReceiverAmountByCardNumber:output_type -> pb.ApiResponseYearlyAmount
	12, // 87: pb.CardService.CreateCard:output_type -> pb.ApiResponseCard
	12, // 88: pb.CardService.UpdateCard:output_type -> pb.ApiResponseCard
	13, // 89: pb.CardService.TrashedCard:output_type -> pb.ApiResponseCardDeleteAt
	13, // 90: pb.CardService.RestoreCard:output_type -> pb.ApiResponseCardDeleteAt
	14, // 91: pb.CardService.DeleteCardPermanent:output_type -> pb.ApiResponseCardDelete
	15, // 92: pb.CardService.RestoreAllCard:output_type -> pb.ApiResponseCardAll
	15, // 93: pb.CardService.DeleteAllCardPermanent:output_type -> pb.ApiResponseCardAll
