...
const file_transfer_proto_rawDesc = "" +
	...
	"\x06status\x18\x01 \x01(\tR\x06status\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12(\n" +
	"\x04data\x18\x03 \x01(\v2\x14.pb.TransferResponseR\x04data\"\x81\x01\n" +
	"\x1bApIResponseTransferDeleteAt\x12\x16\n" +
	"\x06status\x18\x01 \x01(\tR\x06status\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x120\n" +
	"\x04data\x18\x03 \x01(\v2\x1c.pb.TransferResponseDeleteAtR\x04data\"r\n" +
	...
	"\x0eUpdateTransfer\x12\x19.pb.UpdateTransferRequest\x1a\x17.pb.ApiResponseTransfer\x12L\n" +
	"\x0fTrashedTransfer\x12\x1b.pb.FindByIdTransferRequest\x1a\x1c.pb.TransferResponseDeleteAt\x12L\n" +
	"\x0fRestoreTransfer\x12\x1b.pb.FindByIdTransferRequest\x1a\x1c.pb.TransferResponseDeleteAt\x12U\n" +
	...
	"\x1aDeleteAllTransferPermanent\x12\x16.google.protobuf.Empty\x1a\x1a.pb.ApiResponseTransferAll\"\x00B;Z9github.com/MamangRust/monolith-graphql-payment-gateway-pbb\x06proto3"
...
var file_transfer_proto_goTypes = []any{
	...
	(*ApIResponseTransferDeleteAt)(nil),           // 26: pb.ApIResponseTransferDeleteAt
	(*ApiResponseTransfers)(nil),                  // 27: pb.ApiResponseTransfers
	(*ApiResponseTransferDelete)(nil),             // 28: pb.ApiResponseTransferDelete
	(*ApiResponseTransferAll)(nil),                // 29: pb.ApiResponseTransferAll
	(*ApiResponsePaginationTransfer)(nil),         // 30: pb.ApiResponsePaginationTransfer
	(*ApiResponsePaginationTransferDeleteAt)(nil), // 31: pb.ApiResponsePaginationTransferDeleteAt
...
var file_transfer_proto_depIdxs = []int32{
	32, // 0: pb.TransferResponseDeleteAt.deleted_at:type_name -> google.protobuf.StringValue
	...
	12, // 8: pb.ApIResponseTransferDeleteAt.data:type_name -> pb.TransferResponseDeleteAt
	11, // 9: pb.ApiResponseTransfers.data:type_name -> pb.TransferResponse
	11, // 10: pb.ApiResponsePaginationTransfer.data:type_name -> pb.TransferResponse
	33, // 11: pb.ApiResponsePaginationTransfer.pagination:type_name -> pb.PaginationMeta
	12, // 12: pb.ApiResponsePaginationTransferDeleteAt.data:type_name -> pb.TransferResponseDeleteAt
	33, // 13: pb.ApiResponsePaginationTransferDeleteAt.pagination:type_name -> pb.PaginationMeta
	5,  // 14: pb.TransferService.FindAllTransfer:input_type -> pb.FindAllTransferRequest
	6,  // 15: pb.TransferService.FindByIdTransfer:input_type -> pb.FindByIdTransferRequest
	2,  // 16: pb.TransferService.FindMonthlyTransferStatusSuccess:input_type -> pb.FindMonthlyTransferStatus
	1,  // 17: pb.TransferService.FindYearlyTransferStatusSuccess:input_type -> pb.FindYearTransferStatus
	2,  // 18: pb.TransferService.FindMonthlyTransferStatusFailed:input_type -> pb.FindMonthlyTransferStatus
	1,  // 19: pb.TransferService.FindYearlyTransferStatusFailed:input_type -> pb.FindYearTransferStatus
	4,  // 20: pb.TransferService.FindMonthlyTransferStatusSuccessByCardNumber:input_type -> pb.FindMonthlyTransferStatusCardNumber
	3,  // 21: pb.TransferService.FindYearlyTransferStatusSuccessByCardNumber:input_type -> pb.FindYearTransferStatusCardNumber
	4,  // 22: pb.TransferService.FindMonthlyTransferStatusFailedByCardNumber:input_type -> pb.FindMonthlyTransferStatusCardNumber
	3,  // 23: pb.TransferService.FindYearlyTransferStatusFailedByCardNumber:input_type -> pb.FindYearTransferStatusCardNumber
	1,  // 24: pb.TransferService.FindMonthlyTransferAmounts:input_type -> pb.FindYearTransferStatus
	1,  // 25: pb.TransferService.FindYearlyTransferAmounts:input_type -> pb.FindYearTransferStatus
	0,  // 26: pb.TransferService.FindMonthlyTransferAmountsBySenderCardNumber:input_type -> pb.FindByCardNumberTransferRequest
	0,  // 27: pb.TransferService.FindMonthlyTransferAmountsByReceiverCardNumber:input_type -> pb.FindByCardNumberTransferRequest
	0,  // 28: pb.TransferService.FindYearlyTransferAmountsBySenderCardNumber:input_type -> pb.FindByCardNumberTransferRequest
	0,  // 29: pb.TransferService.FindYearlyTransferAmountsByReceiverCardNumber:input_type -> pb.FindByCardNumberTransferRequest
	7,  // 30: pb.TransferService.FindTransferByTransferFrom:input_type -> pb.FindTransferByTransferFromRequest
	8,  // 31: pb.TransferService.FindTransferByTransferTo:input_type -> pb.FindTransferByTransferToRequest
	5,  // 32: pb.TransferService.FindByActiveTransfer:input_type -> pb.FindAllTransferRequest
	5,  // 33: pb.TransferService.FindByTrashedTransfer:input_type -> pb.FindAllTransferRequest
	9,  // 34: pb.TransferService.CreateTransfer:input_type -> pb.CreateTransferRequest
	10, // 35: pb.TransferService.UpdateTransfer:input_type -> pb.UpdateTransferRequest
	6,  // 36: pb.TransferService.TrashedTransfer:input_type -> pb.FindByIdTransferRequest
	6,  // 37: pb.TransferService.RestoreTransfer:input_type -> pb.FindByIdTransferRequest
	6,  // 38: pb.TransferService.DeleteTransferPermanent:input_type -> pb.FindByIdTransferRequest
	34, // 39: pb.TransferService.RestoreAllTransfer:input_type -> google.protobuf.Empty
	34, // 40: pb.TransferService.DeleteAllTransferPermanent:input_type -> google.protobuf.Empty
	30, // 41: pb.TransferService.FindAllTransfer:output_type -> pb.ApiResponsePaginationTransfer
	25, // 42: pb.TransferService.FindByIdTransfer:output_type -> pb.ApiResponseTransfer
	19, // 43: pb.TransferService.FindMonthlyTransferStatusSuccess:output_type -> pb.ApiResponseTransferMonthStatusSuccess
	20, // 44: pb.TransferService.FindYearlyTransferStatusSuccess:output_type -> pb.ApiResponseTransferYearStatusSuccess
	21, // 45: pb.TransferService.FindMonthlyTransferStatusFailed:output_type -> pb.ApiResponseTransferMonthStatusFailed
	22, // 46: pb.TransferService.FindYearlyTransferStatusFailed:output_type -> pb.ApiResponseTransferYearStatusFailed
	19, // 47: pb.TransferService.FindMonthlyTransferStatusSuccessByCardNumber:output_type -> pb.ApiResponseTransferMonthStatusSuccess
	20, // 48: pb.TransferService.FindYearlyTransferStatusSuccessByCardNumber:output_type -> pb.ApiResponseTransferYearStatusSuccess
	21, // 49: pb.TransferService.FindMonthlyTransferStatusFailedByCardNumber:output_type -> pb.ApiResponseTransferMonthStatusFailed
	22, // 50: pb.TransferService.FindYearlyTransferStatusFailedByCardNumber:output_type -> pb.ApiResponseTransferYearStatusFailed
	23, // 51: pb.TransferService.FindMonthlyTransferAmounts:output_type -> pb.ApiResponseTransferMonthAmount
	24, // 52: pb.TransferService.FindYearlyTransferAmounts:output_type -> pb.ApiResponseTransferYearAmount
	23, // 53: pb.TransferService.FindMonthlyTransferAmountsBySenderCardNumber:output_type -> pb.ApiResponseTransferMonthAmount
	23, // 54: pb.TransferService.FindMonthlyTransferAmountsByReceiverCardNumber:output_type -> pb.ApiResponseTransferMonthAmount
	24, // 55: pb.TransferService.FindYearlyTransferAmountsBySenderCardNumber:output_type -> pb.ApiResponseTransferYearAmount
	24, // 56: pb.TransferService.FindYearlyTransferAmountsByReceiverCardNumber:output_type -> pb.ApiResponseTransferYearAmount
	27, // 57: pb.TransferService.FindTransferByTransferFrom:output_type -> pb.ApiResponseTransfers
	27, // 58: pb.TransferService.FindTransferByTransferTo:output_type -> pb.ApiResponseTransfers
	31, // 59: pb.TransferService.FindByActiveTransfer:output_type -> pb.ApiResponsePaginationTransferDeleteAt
	31, // 60: pb.TransferService.FindByTrashedTransfer:output_type -> pb.ApiResponsePaginationTransferDeleteAt
	25, // 61: pb.TransferService.CreateTransfer:output_type -> pb.ApiResponseTransfer
	25, // 62: pb.TransferService.UpdateTransfer:output_type -> pb.ApiResponseTransfer
	12, // 63: pb.TransferService.TrashedTransfer:output_type -> pb.TransferResponseDeleteAt
	12, // 64: pb.TransferService.RestoreTransfer:output_type -> pb.TransferResponseDeleteAt
	28, // 65: pb.TransferService.DeleteTransferPermanent:output_type -> pb.ApiResponseTransferDelete
	29, // 66: pb.TransferService.RestoreAllTransfer:output_type -> pb.ApiResponseTransferAll
	29, // 67: pb.TransferService.DeleteAllTransferPermanent:output_type -> pb.ApiResponseTransferAll
