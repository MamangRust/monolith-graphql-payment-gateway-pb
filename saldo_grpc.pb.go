...
func (c *saldoServiceClient) TrashedSaldo(ctx context.Context, in *FindByIdSaldoRequest, opts ...grpc.CallOption) (*ApiResponseSaldoDeleteAt, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *saldoServiceClient) RestoreSaldo(ctx context.Context, in *FindByIdSaldoRequest, opts ...grpc.CallOption) (*ApiResponseSaldoDeleteAt, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ApiResponseSaldoDeleteAt)
...
func (UnimplementedSaldoServiceServer) TrashedSaldo(context.Context, *FindByIdSaldoRequest) (*ApiResponseSaldoDeleteAt, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TrashedSaldo not implemented")
}
func (UnimplementedSaldoServiceServer) RestoreSaldo(context.Context, *FindByIdSaldoRequest) (*ApiResponseSaldoDeleteAt, error) {
