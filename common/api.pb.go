...
const file_common_api_proto_rawDesc = "" +
	"\n" +
	"\x10common/api.proto\x12\tpb.common\"\x96\x01\n" +
	...
	"\x04code\x18\x03 \x01(\x05R\x04codeBBZ@github.com/MamangRust/monolith-graphql-payment-gateway-pb/commonb\x06proto3"
...
var file_common_api_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_common_api_proto_goTypes = []any{
	(*PaginationMeta)(nil), // 0: pb.common.PaginationMeta
	(*ErrorResponse)(nil),  // 1: pb.common.ErrorResponse
}
