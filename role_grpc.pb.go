...
type RoleServiceClient interface {
	...
	TrashedRole(ctx context.Context, in *FindByIdRoleRequest, opts ...grpc.CallOption) (*ApiResponseDeleteAt, error)
	RestoreRole(ctx context.Context, in *FindByIdRoleRequest, opts ...grpc.CallOption) (*ApiResponseDeleteAt, error)
...
func (c *roleServiceClient) TrashedRole(ctx context.Context, in *FindByIdRoleRequest, opts ...grpc.CallOption) (*ApiResponseDeleteAt, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ApiResponseDeleteAt)
...
func (c *roleServiceClient) RestoreRole(ctx context.Context, in *FindByIdRoleRequest, opts ...grpc.CallOption) (*ApiResponseDeleteAt, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ApiResponseDeleteAt)
...
type RoleServiceServer interface {
	...
	TrashedRole(context.Context, *FindByIdRoleRequest) (*ApiResponseDeleteAt, error)
	RestoreRole(context.Context, *FindByIdRoleRequest) (*ApiResponseDeleteAt, error)
...
func (UnimplementedRoleServiceServer) TrashedRole(context.Context, *FindByIdRoleRequest) (*ApiResponseDeleteAt, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TrashedRole not implemented")
}
func (UnimplementedRoleServiceServer) RestoreRole(context.Context, *FindByIdRoleRequest) (*ApiResponseDeleteAt, error) {
