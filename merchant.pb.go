...
var file_merchant_proto_goTypes = []any{
	...
	(*UpdateMerchantStatusRequest)(nil),              // 2: pb.UpdateMerchantStatusRequest
	(*MerchantResponse)(nil),                         // 3: pb.MerchantResponse
	(*MerchantResponseDeleteAt)(nil),                 // 4: pb.MerchantResponseDeleteAt
	(*MerchantTransactionResponse)(nil),              // 5: pb.MerchantTransactionResponse
	(*MerchantResponseMonthlyPaymentMethod)(nil),     // 6: pb.MerchantResponseMonthlyPaymentMethod
	(*MerchantResponseYearlyPaymentMethod)(nil),      // 7: pb.MerchantResponseYearlyPaymentMethod
	(*MerchantResponseMonthlyAmount)(nil),            // 8: pb.MerchantResponseMonthlyAmount
	(*MerchantResponseYearlyAmount)(nil),             // 9: pb.MerchantResponseYearlyAmount
	(*MerchantResponseMonthlyTotalAmount)(nil),       // 10: pb.MerchantResponseMonthlyTotalAmount
	(*MerchantResponseYearlyTotalAmount)(nil),        // 11: pb.MerchantResponseYearlyTotalAmount
	(*ApiResponseMerchantMonthlyPaymentMethod)(nil),  // 12: pb.ApiResponseMerchantMonthlyPaymentMethod
	(*ApiResponseMerchantYearlyPaymentMethod)(nil),   // 13: pb.ApiResponseMerchantYearlyPaymentMethod
	(*ApiResponseMerchantMonthlyAmount)(nil),         // 14: pb.ApiResponseMerchantMonthlyAmount
	(*ApiResponseMerchantYearlyAmount)(nil),          // 15: pb.ApiResponseMerchantYearlyAmount
	(*ApiResponseMerchantMonthlyTotalAmount)(nil),    // 16: pb.ApiResponseMerchantMonthlyTotalAmount
...
var file_merchant_proto_depIdxs = []int32{
	...
	9,  // 5: pb.ApiResponseMerchantYearlyAmount.data:type_name -> pb.MerchantResponseYearlyAmount
	10, // 6: pb.ApiResponseMerchantMonthlyTotalAmount.data:type_name -> pb.MerchantResponseMonthlyTotalAmount
