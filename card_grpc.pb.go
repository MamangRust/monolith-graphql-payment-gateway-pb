...
func (c *cardServiceClient) TrashedCard(ctx context.Context, in *FindByIdCardRequest, opts ...grpc.CallOption) (*ApiResponseCardDeleteAt, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *cardServiceClient) RestoreCard(ctx context.Context, in *FindByIdCardRequest, opts ...grpc.CallOption) (*ApiResponseCardDeleteAt, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ApiResponseCardDeleteAt)
...
func (UnimplementedCardServiceServer) TrashedCard(context.Context, *FindByIdCardRequest) (*ApiResponseCardDeleteAt, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TrashedCard not implemented")
}
func (UnimplementedCardServiceServer) RestoreCard(context.Context, *FindByIdCardRequest) (*ApiResponseCardDeleteAt, error) {
